...
layout(location=7) flat in int instanceIndexVS;
layout(location=8) in vec4 modelPositionVS;
#endif
...
void main() {
    ...
    vec4 modelPositionFS = PushConstants.lightSpaceMatrix * mMatrix * vec4(modelPosition.xyz, 1.0);
