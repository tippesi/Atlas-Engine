...
namespace Atlas {
    ...
    public:
        ...
        vec3 Project(vec3 point, const Scene::Components::CameraComponent& camera) const;
         ...
         */
        vec3 Unproject(vec3 point, const Scene::Components::CameraComponent& camera) const;
