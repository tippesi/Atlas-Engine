...
namespace Atlas {
    ...
    VulkanMaterial::VulkanMaterial(const VulkanMaterial& that) {
    ...
    VulkanMaterial& VulkanMaterial::operator=(const VulkanMaterial& that) {
    ...
    bool VulkanMaterial::HasBaseColorMap() const {

        return baseColorMap ? true : false;

    }

    bool VulkanMaterial::HasOpacityMap() const {

        return opacityMap ? true : false;

    }

    bool VulkanMaterial::HasNormalMap() const {

        return normalMap ? true : false;

    }

    bool VulkanMaterial::HasRoughnessMap() const {

        return roughnessMap ? true : false;

    }

    bool VulkanMaterial::HasMetalnessMap() const {

        return metalnessMap ? true : false;

    }

    bool VulkanMaterial::HasAoMap() const {

        return aoMap ? true : false;

    }

    bool VulkanMaterial::HasDisplacementMap() const {
    ...
    void VulkanMaterial::DeepCopy(const VulkanMaterial& that) {
        ...
        normalMap = that.normalMap;
        roughnessMap = that.roughnessMap;
        metalnessMap = that.metalnessMap;
        aoMap = that.aoMap;
        displacementMap = that.displacementMap;
